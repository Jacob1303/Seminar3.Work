...
Поочередное введение данных команд позволит Вам отправить в удалённый репозиторий текущий открытый Вами локальный репозиторий. Ключевой здесь является команда:
