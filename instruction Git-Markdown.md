...
Создание альтернативной версии редактируемого документа для внесения корректировок/отработки новых возможностей, которые могут нанести ущерб основному файлу можно реализовать с помощью создания дополнительных веток редактирования.
