...
Коммиты с ***b041e40*** по ***e1285e5*** создавались в разных ветках с попытками вывести их на конфликт. Но не было учтено Ваше замечание о создании паралельных коммитов в **master**. Поэтому нет ветвления, нет коммитов и конфликтов. Дальнейшие вариации коммитов созданы только для выполнения домашнего задания и не несут смысловой нагрузки для инструкции. Данное замечание будет удалено в итоговой версии инструкции. Спасибо!