...
Выводимая информация будет содержать номер коммита, автора коммита и дату/время его добавления. После просмотра всего перечня коммитов необходимо с помощь клавиши "q" вернуть в работу в терминале.
...
Пользователь увидит текст коммитов и их краткий номер.
